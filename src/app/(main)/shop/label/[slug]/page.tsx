// src/app/(main)/shop/label/[slug]/page.tsx
...
export async function generateMetadata(props: Props): Promise<Metadata> {
  ...
  const description = `Shop vinyl records, CDs and cassettes from ${filter.display_name}. Browse releases from this label at The Mixtape Club.`
  const url = `${getBaseURL()}/shop/label/${params.slug}`
