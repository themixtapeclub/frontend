...
function FreeShippingPopup({
  ...
  return (
    ...
    >
      ...
      <div className="w-[400px] bg-black text-white p-4 rounded-lg ">
        <div className="pb-4">
        ...
        <div className="flex gap-3">
          ...
          <LocalizedClientLink
            className="flex-grow rounded-2xl bg-white text-black shadow-none outline-none border-[1px] border-white text-[15px] py-2.5 px-4 text-center"
            href="/store"
          >
            View products
          </LocalizedClientLink>
