...
// Replace the format case with special handling for vinyl formats
const newFormatCase = `    case 'format':
      ...
      // Special handling for vinyl formats
      const vinylVariations = [];
      if (slug === '7' || slug === '7-inch' || formatName.includes('7')) {
        vinylVariations.push('"7\\"" in format[].main', 'format[].main == "7\\""', '"7-inch" in format[].main', '"7 inch" in format[].main');
      }
      if (slug === '12' || slug === '12-inch' || formatName.includes('12')) {
        vinylVariations.push('"12\\"" in format[].main', 'format[].main == "12\\""', '"12-inch" in format[].main', '"12 inch" in format[].main');
      }
...
console.log('✅ Fixed format filter to handle 7" and 12" vinyl formats');
